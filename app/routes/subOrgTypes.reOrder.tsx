...
import { OrderByType, PAGE_MARGIN } from "~/models/misc";

import {
  getAllActiveOrgTypes,
  getAllOrgTypes,
  updateOrgTypesReOrder,
} from "~/controllers/orgTypes";
import NavBar from "~/components/nav";
import {
  getAllActiveSubOrgTypes,
  getAllSubOrgTypes,
  updateSubOrgTypeReOrder,
...
export const loader = async ({ request }: LoaderFunctionArgs) => {
  ...
  let list;
  if (qq) list = await getAllSubOrgTypes();
  else list = await getAllActiveSubOrgTypes();
...
export const action = async ({ request }: ActionFunctionArgs) => {
  ...
  const rval = await updateSubOrgTypeReOrder(data);
...
export default function SubOrgTypesReOrder() {
